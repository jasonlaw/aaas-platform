...
exists_file "$TENANT_DIR/vault/Reference/Business Data.md" "tenant_business_data_note"
...
contains "$TENANT_DIR/SOUL.md" 'Reference/Business Data.md' "soul_documents_business_data_note"
